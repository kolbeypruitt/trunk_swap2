...
var dbLib = {
  insertTrunkOffer: function (trunkOffer, user) {
    ...
    ,current_model: trunkOffer.cur_model ,current_style: trunkOffer.cur_style
    ,desired_year: trunkOffer.des_year   ,desired_model: trunkOffer.des_model
    ,desired_style: trunkOffer.des_style ,user_id: user._id
    })
  ...
  findMyMatches: function (userId) {
    usersdb.findOne({_id: userId}).then(function (user) {
